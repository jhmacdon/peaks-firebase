...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.16),_transparent_30%),linear-gradient(180deg,_#f8fafc,_#eef2ff_40%,_#f8fafc)] dark:bg-gray-950">
      <div className="mx-auto grid min-h-screen max-w-6xl gap-10 px-6 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <section className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-4 py-1.5 text-sm text-blue-700 shadow-sm backdrop-blur dark:border-blue-900 dark:bg-gray-900/80 dark:text-blue-300">
          ...
          <div className="space-y-4">
            <h1 className="max-w-xl text-4xl font-semibold tracking-tight text-gray-950 dark:text-white sm:text-5xl">
              Sign in to keep your routes, reports, and summit progress in one place.
            </h1>
            <p className="max-w-2xl text-base leading-7 text-gray-600 dark:text-gray-300">
              Jump back into saved plans, log new outings, browse route beta, and
              track the lists you’re chasing without losing your place.
            </p>
          </div>
          <div className="grid gap-3 sm:grid-cols-3">
            {[
              ["Map-first planning", "Open topo maps, route geometry, and destination details from the same workflow."],
              ["Trip reports", "Read field notes from other hikers and publish your own beta with photos."],
              ["Progress tracking", "Keep your lists, sessions, and planning history attached to your account."],
            ].map(([title, body]) => (
              <div
                key={title}
        ...
        <div className="w-full rounded-[28px] border border-white/70 bg-white/90 p-8 shadow-xl backdrop-blur dark:border-gray-800 dark:bg-gray-900/90">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Pick up where you left off and keep your mountain history synced.
          </p>
