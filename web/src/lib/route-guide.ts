...
/** Keep only route guidance that the stat row cannot say. Distance, gain,
 * time, difficulty, and session count already have named fields above the
 * fold; turning them into sentences below only repeats the page. */
